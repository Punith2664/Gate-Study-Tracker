  ...
  measurementId: "G-WGSPK78XB2"
    ...
    async function loadDataFromFirebase() {
        ...
        if (doc.exists) {
            ...
            appData = { todos: [], subjects: {}, customMinutes: 25, studySessions: [], workouts: [], loginHistory: [] };
        }
    ...
    function logStudySession(durationInSeconds){(appData.studySessions=appData.studySessions||[]).push({date:new Date().toISOString(),duration:durationInSeconds});updateStatsDisplay();saveData()}
